...
<title>findbass.lk</title>
    <link rel="icon" type="image/png" href="ASSETS\titleicon1.png">
</head>
<body>
	<style>
		*
...
if ($conn->connect_error) {
    die("Connection failed: " . $conn->connect_error);
                ...
                {  
                  ...
                  <td>
                  <form action="" method="POST">
                  <input class="input_type" type="" name="user_promote_id" value="'.$row['id'].'">
                  <input class="sub" type="submit" name="user_promote" value="" id="promote"><br>
                  </form>
                  </td>'; 
                  echo '
                  <td>
...
if (isset($_POST['cap_demote']))
{
  ...
  else
  {
    ...
    $sql = "UPDATE login SET statues='user' WHERE id=$id";

    if ($conn->query($sql) === TRUE) {

                $sqlinsert2 = "INSERT INTO activities (id, description, uploaded_date) 
                VALUES (NULL, '<b><i>$user</i></b> (former Moderator) has been demoted by <b><i>$get_admin_name</i></b>', CURRENT_TIMESTAMP)";
...
if (isset($_POST['cap_remove']))
{
  ...
  else
  {
    ...
    if ($conn->query($sql) === TRUE) {
                ...
                $sqlinsert2 = "INSERT INTO activities (id, description, uploaded_date) 
                VALUES (NULL, '<b><i>$get_admin_name</i></b>  Removed  <b><i>$user</i></b> (former Moderator)', CURRENT_TIMESTAMP)";
...
<!--User -->
  <?php
/* User promote-------------------------------------------------------------------------*/
if (isset($_POST['user_promote']))
{
  $id= $_POST["user_promote_id"];
  if ($id==='') 
  {
  ...
  else
  {
    ...
    if ($conn->query($sql) === TRUE) {
                ...
                $sqlinsert2 = "INSERT INTO activities (id, description, uploaded_date) 
                VALUES (NULL, '<b><i>$user</i></b> (former Mechanic) has been promoted by <b><i>$get_admin_name</i></b>', CURRENT_TIMESTAMP)";
...
if (isset($_POST['staff_remove']))
{
  ...
  else
  {
    ...
    if ($conn->query($sql) === TRUE) {
                ...
                $sqlinsert2 = "INSERT INTO activities (id, description, uploaded_date) 
                VALUES (NULL, '<b><i>$get_admin_name</i></b>  Removed  <b><i>$user</i></b> (Client)', CURRENT_TIMESTAMP)";
...
if (isset($_POST['user_remove']))
{
  ...
  else
  {
    ...
    if ($conn->query($sql) === TRUE) {
                ...
                $sqlinsert2 = "INSERT INTO activities (id, description, uploaded_date) 
                VALUES (NULL, '<b><i>$get_admin_name</i></b>  Removed  <b><i>$user</i></b> (Former Mechanic)', CURRENT_TIMESTAMP)";
