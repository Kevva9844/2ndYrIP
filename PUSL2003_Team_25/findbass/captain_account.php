...
$sql = "SELECT * FROM login WHERE username='$get_captain_name'";
...
if ($conn->query($sql) === TRUE) {
  ...
  VALUES (NULL, ' <b><i>$get_captain_name</i></b> (Moderator) Created a <i>User</i> Account as <b><i>$newusername</i></b>', CURRENT_TIMESTAMP)";
...
::-ms-input-placeholder { /* Microsoft Edge */
   color: darkgrey;
	...
	<header>
        ...
        <li class="active"><a href="captain_account.php">ACCOUNT</a></li>
...
<!--main-->
    <div class="main">
<center>
  <div class="pro_pic"><img src="ASSETS\captain_100px.png" style="width: 100px; height: 100px; padding-top: 25px; "></div>
  <br>
  <p style="color: gray; font-size: 20px;"> <?php echo $get_captain_name; ?></p> <br>
  <center>
...
<button class="open-button" onclick="openForm()">Add a Mechanic</button>
</div>
</center>
</center>
