...
@media screen and (max-width: 400px) {
	...
	<header>
        ...
        <li class="active"><a href="user_report.php">REPORT</a></li>
...
<!--main-->
    <div class="main">
<center>
<div class="activity_head">Report</div>
</center>
<br><br>
...
<?php
  ...
  $query = "SELECT * FROM report where username = '$get_user_name' ORDER BY uploaded_date DESC";  
