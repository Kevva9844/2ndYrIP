...
$password = "";
$dbname = "findbass";
if ($newFirstName!=NULL||$newLastName!=NULL||$newusername!=NULL||$newpassword!=NULL||$newemail||$newstatues!=NULL) 
{
//echo "working";
//echo "<br>";
// Create connection
    ...
    <div class="Create_account">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" enctype="multipart/form-data">
            ...
            <select name="new_statues">
              <option value="staff" style="color: black; background-color: #ddd;">Client</option>
              <option value="user" style="color: black; background-color: #ddd;">Mechanic</option>
            </select>
            <br><br>
