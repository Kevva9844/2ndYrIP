...
@media screen and (max-width: 400px) {
	...
	<header>
        ...
        <li class="active"><a href="admin_contact.php">CONTACT</a></li>
...
<!--main-->
    <div class="main">
      <center>
      <div><img src="findbassicon2.png" style="width: 500px; height: 200px;  margin-top: 100px;"> </div><br>
      <div style="width: 800px;">
          <table>
            <tr>
              <td><img src="ASSETS\facebook.png"></td>
              <td style="padding-left: 20px;"><p><i>https://www.facebook.com/findbass</i></p></td>
            </tr>
            <tr>
              <td><img src="ASSETS\gmail.png"></td>
              <td style="padding-left: 20px;"><p><i>findbass44@gmail.com</i></p></td>
            </tr>
            <tr>
              <td><img src="ASSETS\Twitter.png"></td>
              <td style="padding-left: 20px;"><p><i>https://www.twitter.com/findbass</i></p></td>
            </tr>
          </table>
      </div>
      </center>
