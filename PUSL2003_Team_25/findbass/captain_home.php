...
@media screen and (max-width: 400px) {
	...
	<header>
		<div>
			...
			<ul class="main-nav">
				<li class="active"><a href="captain_home.php">HOME</a></li>
                    ...
                    <table style="font-family: monospace; margin-left: 20px;">
            			<tr>
              				...
              				<td style="padding-left: 20px;">
              					<center>
                          <form action="captain_info.php" target="_blank" method="POST">
...
if (isset($_POST['confirmedgetid'])) 
{
	...
	if ($result1->num_rows > 0) 
	{
		...
		if ($conn->query($sql) === TRUE) 
		{
						...
						' Confirmed <b><i>$val</i></b>  loacation has been <b>deleted</b> by <b><i>$get_captain_name</i></b> (Captain) <br> Location added by - <i>$user_name</i>'
						, CURRENT_TIMESTAMP)";

						if ($conn->query($sqlinsert) === TRUE) 
						{
                $sqlinsert2 = "INSERT INTO report (id, description, uploaded_date, username) 
                VALUES (NULL, ' For Some reason Your location <b><i>$val</i></b> has been <b><i>Removed</i></b> by <b><i>$get_captain_name</i></b> (Captain)', CURRENT_TIMESTAMP,'$user_name')";
...
if (isset($_POST['unconfirmedgetid'])) 
{
  ...
  if ($result1->num_rows > 0) 
  {
    ...
    {
            $sqlinsert = "INSERT INTO activities (id, description, uploaded_date) VALUES (NULL, 
            'An Unconfirmed <b><i>$val</i></b>  loacation has been <b>deleted</b> by <b><i>$get_captain_name</i></b> (Captain) <br> Location added by - <i>$user_name</i>'
            , CURRENT_TIMESTAMP)";

            if ($conn->query($sqlinsert) === TRUE) 
            {
                $sqlinsert2 = "INSERT INTO report (id, description, uploaded_date, username) 
                VALUES (NULL, 'Your location <b><i>$val</i></b> has been <b><i>Declined</i></b> and Removed by <b><i>$get_captain_name</i></b> (Captain)  ', CURRENT_TIMESTAMP,'$user_name')";
...
?>
        ...
        <script>
            ...
            function initMap() 
            {
                ...
                map = new google.maps.Map(document.getElementById('map'), {center: myCenter,zoom: 18});
            ...
            function saveData() 
            {
                ...
                var url = 'locations_model.php?confirm_location_bycaptain&id=' + id + '&confirmed=' + confirmed ;
