...
.pro_pic
{
  ...
  border-radius: 50%;
  margin-top: 50px;
  background-image: "findbassicon.png";
}
#account_table {
...
<div class="form-popup" id="myForm">
  ...
  <form  action="" method="POST" enctype="multipart/form-data">
            ...
            <select name="new_statues">
              <option value="user" style="color: black; background-color: #ddd;">Mechanics</option>
              <option value="captain" style="color: black; background-color: #ddd;">Mods</option>
            </select>
            <br><br>
